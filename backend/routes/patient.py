...
from schemas.patient import PatientResponseSchema, PatientCreateSchema, PatientUpdateSchema
...
@patient_router.put("/{patient_id}", response_model=PatientResponseSchema)
